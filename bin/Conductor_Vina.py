...
""" Conductor to pilot the WarpDrive_Vina.py algorithm """
...
if __name__ == '__main__':
    ...
    for ip in iplist:
        pre_command = "WarpDrive_Vina " \
                      "-results {1}/ " \
                      "-receptor {2} " \
                      "-config {3} " \
                      "-sfactor {4}".format(path, parser.results, parser.receptor, parser.config, parser.sfactor)
